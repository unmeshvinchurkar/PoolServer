...
public class PoolConstants {
	...
	public static final Long NOTI_TRAVELLER_OPTED_OUT_ID = 3L;
	public static final Long NOTI_POOL_HOLIDAY_ID = 4L;
	...
	public static final String NOTI_TRAVELLER_REMOVED_TYPE_NAME = "TRAVELLER_REMOVED";
	public static final String NOTI_TRAVELLER_OPTED_OUT_TYPE_NAME = "TRAVELLER_OPTED_OUT";
	public static final String NOTI_POOL_HOLIDAY_TYPE_NAME = "POOL_HOLIDAY";
